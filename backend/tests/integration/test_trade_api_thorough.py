...
# ======================================================
# REQUEST VALIDATION / NEGATIVE CASES
# ======================================================


def test_trade_analyze_whitespace_query():
    response = client.post(
        "/api/v1/trade/analyze",
        json={"query": "   "},
    )
    ...
    assert response.status_code == 400
    assert response.json()["detail"] == "Trade query cannot be empty."


def test_trade_analyze_missing_query():
    response = client.post(
        "/api/v1/trade/analyze",
        json={},
    )
...
def test_trade_analyze_null_query():
    response = client.post(
        "/api/v1/trade/analyze",
        json={"query": None},
    )
...
def test_trade_analyze_non_string_query():
    response = client.post(
        "/api/v1/trade/analyze",
        json={"query": 12345},
    )
...
def test_trade_analyze_invalid_start_date():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
...
def test_trade_analyze_invalid_end_date():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
            "query": "Find suppliers of electrical panels to India",
...
def test_trade_analyze_start_after_end():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
            "query": "Find suppliers of electrical panels to India",
...
def test_trade_analyze_malformed_json():
    response = client.post(
        "/api/v1/trade/analyze",
        content='{"query": "Find suppliers of electrical panels to India"',
...
def test_trade_analyze_supplier_location_not_supported():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
    ...
    assert response.status_code == 400
    assert "supplier location searches are not yet supported" in (
        response.json()["detail"].lower()
    )


def test_trade_analyze_explicit_valid_period():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
            "query": "Find suppliers of electrical panels to India",
...
# ======================================================
# ADDITIONAL COMPARISON NEGATIVE CASES
# ======================================================


def test_trade_analyze_comparison_same_country():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
...
def test_trade_analyze_comparison_only_one_country():
    response = client.post(
        "/api/v1/trade/analyze",
        json={
...
if __name__ == "__main__":
    ...
    test_trade_analyze_whitespace_query()

    test_trade_analyze_missing_query()

    test_trade_analyze_null_query()

    test_trade_analyze_non_string_query()

    test_trade_analyze_invalid_start_date()

    test_trade_analyze_invalid_end_date()

    test_trade_analyze_start_after_end()

    test_trade_analyze_malformed_json()

    test_trade_analyze_supplier_location_not_supported()

    test_trade_analyze_explicit_valid_period()

    test_trade_analyze_comparison_same_country()

    test_trade_analyze_comparison_only_one_country()
